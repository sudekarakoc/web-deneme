...
export default function DepremOncuIstasyonlariPage() {
  const kategori = "hizmetler";
  const slug = "deprem-oncu-istasyonlari";
      ...
      <div className="w-full bg-[#EAF4E2] pt-[150px] pb-5 px-6 lg:px-8 border-b border-[#73B646]/20">
        <div className="max-w-7xl mx-auto flex flex-col gap-2">
          <div className="flex flex-wrap items-center gap-1.5 text-sm text-gray-600 font-medium tracking-wide">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-[#009FE3] font-bold">{currentPage?.title || "Deprem Öncü İstasyonları"}</span>
          </div>
        </div>
      </div>
        ...
        <div className="w-full flex-1 order-1 lg:order-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <div className="mb-8 border-b border-gray-100 pb-6">
            <h1 className="text-2xl font-bold text-[#1B4F8A] tracking-wide flex items-center gap-3">
              ...
              Deprem Öncü İşaretleri İzleme İstasyonları (KAF Takibi)
            </h1>
            <p className="text-[15px] text-gray-500 mt-2">
              Tekirdağ Büyükşehir Belediyesi deprem öncü işaretleri izleme istasyonları (Barbaros, NKÜ vb.) ile DOHAD ve Kandilli Rasathanesi verilerine aşağıdaki bağlantılardan ulaşabilirsiniz.
            </p>
          </div>
              ...
              >
                <div className="flex items-center gap-3 text-left">
                  <div className="w-10 h-10 shrink-0 rounded-full bg-[#1B4F8A]/5 flex items-center justify-center group-hover:bg-[#8DC63F]/20 transition-colors">
                    <Activity className="w-5 h-5 text-[#1B4F8A] group-hover:text-[#8DC63F] transition-colors" />
                  </div>
